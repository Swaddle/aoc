...
#[inline(always)]
pub fn parse_block(input: &str) -> IResult<&str, i64> {
    ...
    Ok((
        ...
        solve_block((a, b, c, d, p1, p2)),
    ))
}

#[inline(always)]
pub fn parse_input(input: &str) -> IResult<&str, Vec<i64>> {
...
pub fn p1() -> u64 {
    ...
    let (_rem, blocks) = parse_input(&input).unwrap();
    let t1 = t0.elapsed();
    let sol = blocks.iter().sum::<i64>();
